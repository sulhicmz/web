...
- [ ] Lengkapi implementasi `PaymentProvider` agar mendukung skenario checkout + langganan, kupon, dan idempotensi sesuai `docs/plan/11_payment_integration.md`.
- [ ] Tambahkan validasi webhook lanjutan (secret/timestamp) agar sejalan dengan blueprint `docs/plan/11_payment_integration.md`.
- [ ] Bangun pipeline GitHub Actions (lint/build/deploy) sebagaimana digariskan di `docs/plan/15_ci_cd.md`.
...
- [ ] Implementasikan webhook & template WhatsApp Business API sesuai `docs/plan/12_whatsapp_integration.md` (notifikasi invoice/tiket/deploy).
